...
public class Banker {  
    ...
    static int[] available=new int[]{3,3,2};         //资源数  
    ...
    public void getData(){
        ...
        max=bankWindow.TransForm(bankWindow.Max0,bankWindow.Max1,bankWindow.Max2,bankWindow.Max3,bankWindow.Max4);   
        allocation=bankWindow.TransForm(bankWindow.Allocation0,bankWindow.Allocation1,bankWindow.Allocation2,bankWindow.Allocation3,bankWindow.Allocation4);  
      ...
      for (int i = 0; i < allocation.length; i++) {
    	  System.out.print(allocation[3][2]);
